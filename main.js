    ...
    const quizzes = {
        ...
        container2: {
          questions: [
            ...
            { question: 'During which century did the Lost Colony of Greenland go missing?', options: ['1200s', '1300s', '1400s', '1500s'], answer: 1 },
        ...
        container3: {
          questions: [
            ...
            { question: 'What bizarre phenomenon struck the city of Strasbourg in 1518, causing people to uncontrollably dance for days on end?', options: ['Black Death', 'Spanish Inquisition', 'Dancing Plague', 'Witch Trials'], answer: 2 },
